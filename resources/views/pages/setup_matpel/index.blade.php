...
<div class="page-header">
    <h3 class="page-title">
        ...
        </span> Pengaturan Mata Pelajaran
    </h3>
</div>
<div class="row">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <h4 class="card-title">List Data Pengajar</h4>
                    </div>
                    <div class="col-md-6">
                        <a href="{{ route('view.setup_matpel.insert') }}" style="float: right" type="button"
...
@push('scripts')
    <script type="text/javascript">
        ...
        $(document).on('click','.btnHapus' ,function name(params) {
            const url = "{{ route('delete.setup_matpel') }}";
