                        ...
                        <tbody>
                            @forelse ($siswa as $index => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('print.cover_raport',['id' => $item['siswa']['id'],'kelas_id'=>request()->get('kelas_id'),'tahun_ajaran_id'=>request()->get('tahun_ajaran_id')]) }}"
                                            class="btn btn-success btn-sm"><i class="mdi mdi-printer"></i> Cetak Cover Raport</a>
