        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <h4 class="card-title">List Catatan Walikelas</h4>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ route('view.catatan.insert',['kelas_id'=>request()->get('kelas_id'),'tahun_ajaran_id'=>request()->get('tahun_ajaran_id')]) }}" style="float: right"
                        ...
                        <tbody>
                            @forelse ($catatan as $index => $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('view.catatan.edit', $item->id) }}"
...
@push('scripts')
    <script type="text/javascript">
        $(document).on('click', '.btnHapus', function name(params) {
            const url = "{{ route('delete.catatan') }}";
