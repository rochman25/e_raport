            ...
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('update.kompetensi_dasar',$kd->id) }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col">
                                    <div class="form-group @error('kode_kd') has-danger @enderror">
                                        <label for="exampleInputUsername1">Kode Kompetensi Dasar</label>
                                        <input type="text" name="kode_kd" class="form-control" value="{{ $kd->kode_kd }}">
                                        @error('kode_kd')
                                    ...
                                    <div class="form-group @error('matpel_id') has-danger @enderror">
                                        ...
                                        <select id="matpel_id" name="matpel_id" class="form-control">
                                            ...
                                            @foreach ($matpel as $item)
                                                <option value="{{ $item->id }}" @if ($kd->matpel_id == $item->id) selected
                                            @endif>
                                            {{ $item->nama_matpel }}
                                            </option>
                                            @endforeach
                                    ...
                                    <div class="form-group @error('kelas_id') has-danger @enderror">
                                        ...
                                        <select id="kelas_id" name="kelas_id" class="form-control">
                                            ...
                                            @foreach ($kelas as $item)
                                                <option value="{{ $item->id }}" @if ($kd->kelas_id == $item->id) selected
                                            @endif>
                                            {{ $item->nama_kelas }}
                                            </option>
                                            @endforeach
                                    ...
                                    <div class="form-group @error('tahun_ajaran_id') has-danger @enderror">
                                        ...
                                        <select id="tahun_ajaran_id" name="tahun_ajaran_id" class="form-control">
                                            ...
                                            @foreach ($tahun_ajaran as $item)
                                                <option value="{{ $item->id }}" @if ($kd->tahun_ajaran_id == $item->id) selected
                                            @endif>
                                            {{ $item->tahun }}
                                            </option>
                                            @endforeach
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group @error('jenis_kd') has-danger @enderror">
                                        ...
                                        <select id="jenis_kd" name="jenis_kd" class="form-control">
                                            ...
                                            <option value="P" @if($kd->jenis_kd == "P") selected @endif>Pengetahuan</option>
                                            <option value="K" @if($kd->jenis_kd == "K") selected @endif>Keterampilan</option>
                                        </select>
                                        @error('jenis_kd')
                                            <label class="error mt-2 text-danger">{{ $message }}</label>
                                        @enderror
                                ...
                                <div class="col">
                                    <div class="form-group @error('deskripsi') has-danger @enderror">
                                        ...
                                        <textarea rows="5" class="form-control" name="deskripsi">{{ $kd->deskripsi }}</textarea>
                                        @error('deskripsi')
                                            <label class="error mt-2 text-danger">{{ $message }}</label>
                                        @enderror
                                    </div>
