                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link"
                                href="{{ route('view.kompetensi_dasar') }}">Kompetensi
                                Dasar</a>
                        </li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('view.nilai_siswa') }}">Nilai
                                Siswa</a>
                        </li>
                        {{-- @if (count($baseRole->user->guru['walikelas']) > 0) --}}
                        @if ($s_role == 'walikelas')
                            <li class="nav-item"> <a class="nav-link" href="{{ route('view.sikap_spiritual') }}">Nilai
                                    Sikap
                                    Spiritual</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('view.sikap_sosial') }}">Nilai
                                    Sikap
                                    Sosial</a>
                            </li>
                        @endif
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic">
                    <ul class="nav flex-column sub-menu">
                        ...
                        {{-- @if ($s_role == 'walikelas') --}}
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('view.sikap_spiritual') }}">Nilai Sikap
                                    Spiritual</a>
                            </li>
                            <li class="nav-item"> <a class="nav-link" href="{{ route('view.sikap_sosial') }}">Nilai
                                    Sikap
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-cetak">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="{{ route('view.cetak_leger') }}">Export
                                Leger</a>
                        </li>
                    </ul>
                </div>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="ui-basic2">
                    <ul class="nav flex-column sub-menu">
                        ...
                        <li class="nav-item"> <a class="nav-link" href="{{ route('view.setup_kelas') }}">Kelas</a>
                        </li>
